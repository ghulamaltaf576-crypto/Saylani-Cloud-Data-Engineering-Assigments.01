...
-- Note: 'ORDER BY list_price DESC' is used to get the highest 10% 
--products by list_price (Top/Most expensive products). If ascending order is preferred, remove 'DESC'.
